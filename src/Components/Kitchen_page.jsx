...
export const Kitchen_page = () => {
  ...
  const [user, setUser] = useState({name:"Kitchen name", yourname:"your name", bio:"Bio about your kitchen"});
  ...
  return (
    ...
    <div className="kitchen_page_">
        ...
        <div className="sticky">
          <h2>Welcome, <br className="break"/>
             <span> {user.name }</span>
          </h2>
        </div>
        
        <div className="kitchen_page_next_session"></div>
    </div>
